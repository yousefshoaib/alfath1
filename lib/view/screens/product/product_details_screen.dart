        ...
        return  Consumer<ProductProvider>(
          builder: (context, productProvider, child) {
            ...
            if(productProvider.product != null) {
              ...
              double priceWithDiscount = PriceConverter.convertWithDiscount(context, product.price, productProvider.product.discount, productProvider.product.discountType);
