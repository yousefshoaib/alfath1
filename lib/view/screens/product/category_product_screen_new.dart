      ...
      body: Consumer<ProductProvider>(
        builder: (context, productProvider, child) {
          return Column(
            ...
            children: [
              Container(height: 120,width: 1170,child: Consumer<CategoryProvider>(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Container(
                                          padding: EdgeInsets.symmetric(horizontal:10/* Dimensions.PADDING_SIZE_LARGE*/, vertical: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                          alignment: Alignment.center,
                                          margin: EdgeInsets.only(right: Dimensions.PADDING_SIZE_SMALL),
                                          decoration: BoxDecoration(
                                              color: categoryProvider.categorySelectedIndex == -1 ?
                                              Theme.of(context).primaryColor :/*Colors.transparent*/ ColorResources.getGreyColor(context),
                                              borderRadius: BorderRadius.circular(50)),
                                          child:ClipRRect(
                                              borderRadius: BorderRadius.circular(50),
                                              child: Image.asset(Images.app_logo,fit: BoxFit.cover, height: 50, width: 62,)),
                                          /*FadeInImage.assetNetwork(
                                            placeholder: Images.placeholder(context),
                                            image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.categoryImageUrl}/${Images.app_logo}',
                                    ...
                                    itemBuilder: (BuildContext context, int index){
                                      return InkWell(
                                        onTap: (){
                                          ...
                                          Provider.of<ProductProvider>(context, listen: false).initCategoryProductList(
                                            categoryProvider.subCategoryList[index].id.toString(),
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  color: categoryProvider.categorySelectedIndex == index
                                                      ? Theme.of(context).primaryColor :/*Colors.transparent*/ ColorResources.getGreyColor(context),
                                                  borderRadius: BorderRadius.circular(50)),
                                              child:/*Image.asset(categoryProvider.subCategoryList[index].image),*/
                                              ClipRRect(
                                                borderRadius: BorderRadius.circular(50),
                                                child: FadeInImage.assetNetwork(
                                                  placeholder: Images.placeholder(context),
                                                  image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.categoryImageUrl}/${categoryProvider.subCategoryList[index].image}',
                    ...
                    Container(
                      ...
                      child: GridView.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          childAspectRatio: ResponsiveHelper.isDesktop(context)? 0.7 : 2,
