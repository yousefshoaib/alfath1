                  ...
                  ? Row(children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.grey[Provider.
                          of<ThemeProvider>(context).darkTheme ? 900 : 200],
                          /*borderRadius:
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ListTile(
                                    onTap: () {
                                      Navigator.of(context).pushNamed(
                                        RouteHelper.getCategoryProductsRouteNew(id: categoryProvider.subCategoryList[index-1].id,subcategoryName:
